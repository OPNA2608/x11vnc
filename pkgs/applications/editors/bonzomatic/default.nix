...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    substituteInPlace CMakeLists.txt \
      --replace "PLATFORM_LIBS GL asound fontconfig" "PLATFORM_LIBS GL ${if stdenv.hostPlatform.isDarwin then "AudioToolbox AVFoundation CoreAudio CoreGraphics Foundation" else "asound fontconfig"} dl" \
